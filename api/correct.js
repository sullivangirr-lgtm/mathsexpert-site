export default async function handler(req, res) {
  ...
  const modeInstr = {
    detaille: `Produis une correction TRÈS DÉTAILLÉE. Utilise ces balises : <rappel>...</rappel> pour les rappels de cours, <methode>...</methode> pour la méthode, <resultat>...</resultat> pour le résultat final, <erreur>...</erreur> pour les erreurs fréquentes.`,
